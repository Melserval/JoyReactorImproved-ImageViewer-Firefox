;(function(){
	...
	btnShowerClose.style.backgroundImage = `url(${browser.runtime
		.getURL("/content/img/icon-jris-btn-close.png")})`;

	btnDownloadImage.style.backgroundImage = `url(${browser.runtime
		.getURL("/content/img/icon-jris-btn-download.png")})`;

	const urlIconOpenFullscreen = `url(${browser.runtime
		.getURL("/content/img/icon-jris-btn-fullscreen-open.png")})`;

	const urlIconCloseFullscreen = `url(${browser.runtime
		.getURL("/content/img/icon-jris-btn-fullscreen-close.png")})`;

	const urlIconLoaderIndication = `url(${browser.runtime
